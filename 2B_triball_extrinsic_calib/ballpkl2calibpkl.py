...
def a0_read_ballfile(ballfile='ballfile_mat.pkl'):
    ...
    # hflip
    # flip_index = [1,3,5,6]
    # w = intrinsics[0]['image_shape'][1]
    # landmarks_move_xy_mat[flip_index,:,0]   = w - landmarks_move_xy_mat[flip_index,:,0]
    # landmarks_global_xy_mat[flip_index,:,0] = w - landmarks_global_xy_mat[flip_index,:,0]
    # for flip_index_now in flip_index:
    #     background_img[flip_index_now]=background_img[flip_index_now][:,::-1,:]
